...
int main(int argc, const char * argv[]) {
    ...
    while (! videos.empty()) {
        ...
        // ------------------------------------
//        
//        cv::VideoWriter outputVideo1("Output/outputTracker1.mp4",CV_FOURCC('M','P','4','V'),fpsVideo,cv::Size(frameWidth,frameHeight),0);
//        
//        cv::VideoWriter outputVideo2("Output/outputTracker2.mp4",CV_FOURCC('M','P','4','V'),fpsVideo,cv::Size(frameWidth,frameHeight),0);
//        
//        cv::VideoWriter outputVideo3("Output/outputTracker3.mp4",CV_FOURCC('M','P','4','V'),fpsVideo,cv::Size(frameWidth,frameHeight),0);
